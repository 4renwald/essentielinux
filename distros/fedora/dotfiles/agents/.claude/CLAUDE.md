...
- Do not wrap a command that already manages privilege elevation. Package build
  steps must remain unprivileged; elevate only the final system package action.
